...
const fieldVariants = cva(
  "group/field flex w-full gap-3 data-[invalid=true]:text-destructive",
  {
    variants: {
      position: {
        bottom: "fixed inset-x-0 bottom-0 mx-auto max-w-md p-2",
      },
      orientation: {
...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: shadcn realization
    <div
      className={cn(fieldVariants({ orientation, position }), className)}
